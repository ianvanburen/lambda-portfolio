  ...
  return (
    <AboutContainer id="About" >
      ...
      <TextContainer>
        ...
        <p>Paired with my passion for learning are strong communication skills which have helped me to succeed in previous sales & marketing roles. When I’m not mashing computer keys, I enjoy live music, rock climbing, travel and the company of good friends. My ambition is to become a better software engineer each day by way of personal projects, staying current with industry trends, collaborating with others and pursuing new technical interests. Feel free to <a href="https://resume.creddle.io/resume/e1fgpovxad8" target="_blank" rel="noopener noreferrer">check out my resume</a> to learn more about my skills and experience!</p>
      </TextContainer>
    </AboutContainer>
  )
}
