...
const About = () => {
  return (
    <AboutContainer>
      ...
      <p>I'm a Full Stack Web Developer with a passion for tech and coding ideas to life. Through 2+ years of self-taught programming I’ve built several web apps and earned my Front-End Web Development Certificate from freeCodeCamp. I'm now enrolled in Lambda School's Full Stack Web program where I'm building upon my technical foundation, developing new skills and continuing to design applications using the industry's latest technologies.</p>
